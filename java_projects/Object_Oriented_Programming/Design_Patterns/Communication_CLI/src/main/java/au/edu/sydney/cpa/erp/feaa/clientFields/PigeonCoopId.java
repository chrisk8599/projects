...
/**
 * Creates a new Thread to grab the PigeonCoopID of a client
 */
public class PigeonCoopId implements Callable<String> {

    AuthToken token;
    int id;

    public PigeonCoopId(AuthToken token, int id){
        this.token = token;
        this.id = id;
    }
