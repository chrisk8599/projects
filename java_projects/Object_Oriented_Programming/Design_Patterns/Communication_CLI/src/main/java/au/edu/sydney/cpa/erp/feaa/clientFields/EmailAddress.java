...
/**
 * Creates a new Thread to grab the Email Address of a client
 */

public class EmailAddress implements Callable<String> {

    AuthToken token;
    int id;

    public EmailAddress(AuthToken token, int id){
        this.token = token;
        this.id = id;
    }
